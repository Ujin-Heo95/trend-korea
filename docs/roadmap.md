...
| ~~P1-04~~ | ~~**OG 이미지 동적 생성**~~ | 마케팅 | — | ✅ **완료** (2026-04-04) satori+resvg → /api/og-image/:postId, 프리렌더 og:image 폴백 |
...
| ~~P1-11~~ | ~~**AdSense 배치 전략**~~ (AdSlot 컴포넌트) | 프론트 | — | ✅ **완료** (2026-04-04) PostCard 5개마다, 리포트 섹션 간, 이슈 하단, 모바일 sticky |
