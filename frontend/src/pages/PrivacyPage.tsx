  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <div className="space-y-6 text-sm text-slate-700 dark:text-slate-300 leading-relaxed">
        ...
        <section>
          <h2 className="text-lg font-semibold text-slate-800 dark:text-slate-100 mb-2">1. 수집하는 개인정보 항목</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-slate-800 dark:text-slate-100 mb-2">2. 개인정보 수집 및 이용 목적</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-slate-800 dark:text-slate-100 mb-2">3. 개인정보 보유 및 이용 기간</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-semibold text-slate-800 dark:text-slate-100 mb-2">4. 개인정보의 제3자 제공</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-slate-800 dark:text-slate-100 mb-2">5. 쿠키 사용</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-semibold text-slate-800 dark:text-slate-100 mb-2">6. 이용자의 권리</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-slate-800 dark:text-slate-100 mb-2">7. 개인정보 보호책임자</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-slate-800 dark:text-slate-100 mb-2">8. 방침 변경</h2>
          <p>
            본 개인정보처리방침은 법령, 정책, 보안 기술의 변경에 따라 수정될 수 있습니다.
            변경 시 서비스 내 공지를 통해 안내합니다.
          </p>
          <p className="mt-2 text-slate-500 dark:text-slate-400">시행일: 2026년 3월 31일</p>
        </section>
      </div>
    </div>
  );
